...
public class GraphScript <C extends ClientContext> extends PollingScript<C> {
     ...
     */
    protected static abstract class Action<T extends ClientContext> extends ClientAccessor<T> implements Runnable, Comparable<Action<T>>, Validatable {
         ...
         * queue.
         *
         * @param v a new {@link GraphScript.Action.Validator}
